...
We have a function to obtain healthy life expectancy using the Sullivan method. Letøs take a look
```{r}
...
```
What does this tell us about the improvement in mortality and morbity for US women between 1970 and 1990?
...
Let's check that the decomspositionsn yielded realistic results
