...
Following equation one, we need to calculate the country of birth-specific marriage rates, which is the quotient of marriages divided by the exposure for both countries.

```{r}
# Denmark
# Select marriages for first period
# get country-of-birth-specific mortality rates
# Spain
